...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR CodeGeneratorResponse_t9246D6F77031A33A0EB59ED10FB88A4FE8463CD1* U3CU3Ec_U3C_cctorU3Eb__47_0_mE2A0AA1FBDAF3D811AEBD7F9E98675D6359FFBFF (U3CU3Ec_t1F8BFCF164EE5F5B8849D1B47A50DDBD3E528510* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
{
	{
		...
		NullCheck(L_1);
		bool L_4;
		L_4 = VirtualFuncInvoker1< bool, TypeInfo_tC4F59663C70D17D50BC99D53DCE74BFB9701012D* >::Invoke(138, L_1, L_3);
		return L_4;
	}
}
...
IL_0002:
	{
		...
		NullCheck(L_2);
		PropertyInfo_t* L_4;
		L_4 = VirtualFuncInvoker1< PropertyInfo_t*, String_t* >::Invoke(135, L_2, L_3);
		V_1 = L_4;
...
IL_0002:
	{
		...
		NullCheck(L_2);
		MethodInfo_t* L_4;
		L_4 = VirtualFuncInvoker1< MethodInfo_t*, String_t* >::Invoke(134, L_2, L_3);
		V_1 = L_4;
